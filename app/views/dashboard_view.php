...
<body>
    <div class="dashboard-container">
        <!-- Welkomstbericht op het dashboard -->
        <h1>Welkom bij het Dashboard</h1>
        <!-- Persoonlijk welkomsbericht met de gebruikersnaam en rol -->
        <p>Hallo, <?php echo htmlspecialchars($username); ?>! Je bent ingelogd als <?php echo htmlspecialchars($role); ?>.</p>
        
        <!-- Navigatiemenu om naar verschillende beheermodules te gaan -->
        <nav>
            <ul>
        ...
        <!-- Uitlogknop om uit te loggen van de applicatie -->
